# The Sociologist's Era

> *"The most dangerous person in any room is the one 
> who has learned to see the invisible."*
...
Meanwhile the world is burning with problems 
that sociology is uniquely equipped to address.
...
to original research contribution.
...
→ [Read Level 1](curriculum/level-01-sociological-eye.md)

---

### Level 2 — Classical Foundations
**Status: Complete ✓**
...
→ [Read Level 2](curriculum/level-02-classical-foundations.md)

---

### Level 3 — Sociology Applied to the World
**Status: In Progress 🔄**
...
→ [Read Module 01 — Digital Sociology](curriculum/module-01-digital-sociology.md)

---

### Level 4 — Digital Sociology & Health AI
**Status: Planned 📋**
...
→ [Browse working papers](research/working-papers/)
...
→ [Browse case studies](research/case-studies/)
...
→ [Browse reading lists](research/reading-lists/)
...
→ [Browse frameworks](research/frameworks/)
...
- [x] Level 1 complete
- [x] Level 2 complete
- [x] Module 01 — Digital Sociology complete
...
- [ ] Community-contributed modules from  
  researchers in Global South institutions
- [ ] Integration with medical sociology  
  and health AI ethics communities worldwide
- [ ] Curriculum adopted in at least 10 universities  
  as a free supplementary resource
- [ ] Student research contributions published  
...
at [One Patient OneCure](https://onepatientonecure.org),  
...
→ [GitHub Profile](https://github.com/humamzaman)  
→ [ORCID](https://orcid.org/your-orcid-here)  
→ [One Patient OneCure](https://onepatientonecure.org)
